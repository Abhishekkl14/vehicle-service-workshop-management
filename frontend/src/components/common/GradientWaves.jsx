...
export default function GradientWaves({
  ...
  useEffect(() => {
    ...
    contextRef.current = { gl, renderer, program, mesh };
    ...
    const loop = (time) => {
      ...
      const targetX = mouseEnabledRef.current ? targetMouse[0] : 0.5;
      const targetY = mouseEnabledRef.current ? targetMouse[1] : 0.5;
